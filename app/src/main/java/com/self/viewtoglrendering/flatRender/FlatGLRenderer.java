package com.self.viewtoglrendering.flatRender;
...
/**
 * Created by jose on 2018/2/1.
 */

public class FlatGLRenderer extends ViewToGLRenderer {
...
//    private GLBitmap glBitmap;
    ...
    public FlatGLRenderer(Context context) {
