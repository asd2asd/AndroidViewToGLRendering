 ...
 */
public class ViewToTextureView implements TextureView.SurfaceTextureListener,ViewDrawInterface {

    private static final String TAG = ViewToTextureView.class.getSimpleName();
